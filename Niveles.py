...
def randomizarNivel1():
    """Funcion que escoge 3 numeros al azar de una lista definida, 
    eliminandolos posteriormente para evitar que se repitan, retornando 
    la lista con los numeros escogidos, la cual seran las iteraciones.
    """
...
def randomizarNivel2():
    """Funcion que escoge 4 numeros al azar de una lista definida, 
    eliminandolos posteriormente para evitar que se repitan, retornando 
    la lista con los numeros escogidos, la cual seran las iteraciones.
    """
    marcadores= [0,1,2,3,4]
...
def randomizarNivel3():
    """Funcion que escoge 5 numeros al azar de una lista definida, 
    eliminandolos posteriormente para evitar que se repitan, retornando 
    la lista con los numeros escogidos, la cual seran las iteraciones.
    """
    marcadores= [0,1,2,3,4]
...
def cicloNivel1():
    """Funcion que concatena las listas retornadas por la funcion 
...
def primerNivel():
    ...
    del proyecto define en que consiste el nivel 1, haciendo tambien un cambio
...
def segundoNivel():
    """Funcion que con ayuda del codigo proporcionado para la realizacion
    del proyecto define en que consiste el nivel 2, haciendo tambien un cambio
    en la impresion para que muestre al usuario la lista con el nombre de las 
    frutas y no la lista de numeros de cada marcador.
    """
...
def ejecucionPrimerNivel(li:list):
    """Funcion que llamando a la funcion primerNivel ejecuta el nivel 1 para cada 
...
def ejecucionSegundoNivel(li:list):
    """Funcion que llamando a la funcion segundoNivel ejecuta el nivel 2 para cada 
    jugador que se ingrese en la lista de jugadores mediante el menu.
...
def ejecucionTercerNivel(li:list):
    """Funcion que llamando a la funcion tercerNivel ejecuta el nivel 3 para cada 
    jugador que se ingrese en la lista de jugadores mediante el menu.
